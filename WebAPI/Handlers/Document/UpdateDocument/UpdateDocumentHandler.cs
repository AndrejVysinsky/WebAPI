...
{
    public class UpdateDocumentHandler : IRequestHandler<UpdateDocumentRequest, ErrorOr<int>>
    {
        ...
        public async Task<ErrorOr<int>> Handle(UpdateDocumentRequest request, CancellationToken cancellationToken)
        {
